...
<head>
    ...
    <title>{{ config('app.name', 'ModernBlog') }}</title>
    ...
    <meta property="og:title" content="{{ config('app.name', 'ModernBlog') }}">
    <meta property="og:description" content="A modern blogging platform built with Laravel and Vue.js">
    
    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="{{ url()->current() }}">
    <meta property="twitter:title" content="{{ config('app.name', 'ModernBlog') }}">
